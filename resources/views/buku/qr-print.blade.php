...
<head>
    <meta charset="UTF-8">
    <title>Cetak QR - {{ $buku->kode_buku }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card h2 { font-size: 16px; color: #222; margin-bottom: 5px; }
        .card .kode { font-size: 13px; color: #1a6e35; font-weight: 700; margin-bottom: 3px; font-family: monospace; }
