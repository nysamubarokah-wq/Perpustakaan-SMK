...
<div class="container">
    ...
    <div class="logo-panel">
        <img src="{{ asset('images/logo.jpg') }}" alt="Logo SMK Maarif">
        ...
        @if($errors->any())
            <div style="background:#fee2e2;border-left:4px solid #e74c3c;border-radius:8px;padding:12px 15px;margin-bottom:20px">
                @foreach($errors->all() as $e)
                    <p style="color:#dc2626;font-size:13px;margin:0">{{ $e }}</p>
                @endforeach
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_login" placeholder="Masukkan nama lengkap kamu"
                       value="{{ old('nama_login') }}" required autofocus>
            </div>
            <div class="form-group">
