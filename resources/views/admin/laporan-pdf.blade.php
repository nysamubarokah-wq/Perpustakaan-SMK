...
<table style="margin-bottom:20px">
    <tr>
        <td style="width:20%;background:#f0faf4;border:1px solid #1a6e35;border-radius:5px;padding:10px;text-align:center">
            <div style="font-size:20px;font-weight:bold;color:#1a6e35">{{ $totalBuku }}</div>
            <div style="font-size:10px;color:#666">Total Buku</div>
        </td>
        <td style="width:5%"></td>
        <td style="width:20%;background:#f0faf4;border:1px solid #1a6e35;border-radius:5px;padding:10px;text-align:center">
            <div style="font-size:20px;font-weight:bold;color:#1a6e35">{{ $totalAnggota }}</div>
            <div style="font-size:10px;color:#666">Total Anggota</div>
        </td>
        <td style="width:5%"></td>
        <td style="width:20%;background:#f0faf4;border:1px solid #1a6e35;border-radius:5px;padding:10px;text-align:center">
            <div style="font-size:20px;font-weight:bold;color:#1a6e35">{{ $totalPeminjaman }}</div>
        ...
        <td style="width:20%;background:#fff3cd;border:1px solid #856404;border-radius:5px;padding:10px;text-align:center">
            <div style="font-size:20px;font-weight:bold;color:#856404">{{ $sedangDipinjam }}</div>
        ...
        <td style="width:20%;background:#f8d7da;border:1px solid #721c24;border-radius:5px;padding:10px;text-align:center">
            <div style="font-size:20px;font-weight:bold;color:#721c24">{{ $terlambat }}</div>
...
<!-- FOOTER -->
<div class="footer">
    Perpustakaan SMK Maarif Walisongo Kajoran &nbsp;|&nbsp; {{ now()->format('d F Y') }}
</div>
