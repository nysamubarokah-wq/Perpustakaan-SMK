...
<div class="main-container">
    ...
    <h1 class="page-title">
        ...
        @if($favorit->count() > 0)
            <span style="font-size:14px;color:#888;font-weight:400">({{ $favorit->count() }} buku)</span>
        @endif
    </h1>
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <div class="buku-card">
                <div class="buku-cover cover-{{ ($index % 6) + 1 }}">
                    ...
                    <form method="POST" action="{{ route('buku.favorit', $item->id) }}"
                ...
                <div class="buku-body">
                    ...
                    @if($item->genre)
                    <span class="book-card-genre" style="display:inline-block;padding:2px 8px;border-radius:20px;font-size:9px;font-weight:600;background:#f0f0f0;color:#666;margin-top:3px;align-self:flex-start">{{ $item->genre?->nama }}</span>
                    @endif
