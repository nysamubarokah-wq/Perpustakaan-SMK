...
<?php $__env->startSection('page-title', 'Edit E-book'); ?>
...
toggleKoin('<?php echo e(old('is_vip', $ebook->is_vip)); ?>');
</script>
<?php $__env->stopPush(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Edit E-book','icon' => 'bi bi-pencil-square','backUrl' => route('admin.ebook.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit E-book','icon' => 'bi bi-pencil-square','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.ebook.index'))]); ?>
...
<div class="card-admin">
    <div class="card-admin-body">
        <form action="<?php echo e(route('admin.ebook.update', $ebook->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('judul', $ebook->judul)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('penulis', $ebook->penulis)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="is_vip" id="tipeAkses" class="form-control" onchange="toggleKoin(this.value)">
                        <option value="0" <?php echo e(old('is_vip', $ebook->is_vip) == 0 ? 'selected' : ''); ?>>Gratis / Bayar Koin</option>
                        <option value="1" <?php echo e(old('is_vip', $ebook->is_vip) == 1 ? 'selected' : ''); ?>>VIP (akses unlimited)</option>
                    </select>
                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('harga_koin', $ebook->harga_koin)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" rows="4"><?php echo e(old('sinopsis', $ebook->sinopsis)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <?php if($ebook->cover): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(asset('storage/'.$ebook->cover)); ?>" id="coverPreview" style="height:100px;border-radius:8px;object-fit:cover">
                        </div>
                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" accept="image/*" onchange="previewCover(this)">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views/admin/ebook/edit.blade.php ENDPATH**/ ?>