...
<head>
    ...
    <title>Baca: <?php echo e($ebook->judul); ?></title>
...
<div class="top-bar">
    <div class="left">
        <a href="<?php echo e(route('ebook.show', $ebook->id)); ?>" class="btn-back"><i class="bi bi-arrow-left"></i></a>
        <div>
            <div class="title"><?php echo e($ebook->judul); ?></div>
            <div class="author"><?php echo e($ebook->penulis); ?></div>
        </div>
    </div>
    <div class="right">
        <?php if($ebook->is_vip): ?>
        ...
        <?php endif; ?>
        <a href="<?php echo e($pdfUrl); ?>" download class="btn-download" id="btnDownload" onclick="this.innerHTML='<i class=\'bi bi-hourglass-split\'></i> Mengunduh...'">
...
<?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\ebook\baca.blade.php ENDPATH**/ ?>