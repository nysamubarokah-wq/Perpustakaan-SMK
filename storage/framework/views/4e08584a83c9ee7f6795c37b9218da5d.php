...
<nav class="navbar">
    <div class="container-fluid px-4">
        <div class="d-flex align-items-center justify-content-between w-100">
            <a href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')); ?>" class="d-flex align-items-center gap-2 text-decoration-none">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('koleksi.index')); ?>" style="color:#1a6e35;text-decoration:none;font-size:14px;font-weight:500">
