<?php $__env->startSection('header_title', 'Edit Anggota'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Edit Anggota','icon' => 'bi bi-person-gear','backUrl' => $backUrl]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Anggota','icon' => 'bi bi-person-gear','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($backUrl)]); ?>
...
<div class="card-admin">
    <div class="card-admin-body" style="padding:25px">
        <form action="<?php echo e(route('anggota.update', $anggota->id)); ?>?from=<?php echo e(request('from')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama', $anggota->nama)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nis', $anggota->nis)); ?>" placeholder="Nomor Induk Siswa" required>
                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', $anggota->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_telepon', $anggota->no_telepon)); ?>" placeholder="08xxx atau +62xxx">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('kelas', $anggota->kelas)); ?>" placeholder="Contoh: X RPL 1">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('jurusan', $anggota->jurusan)); ?>" placeholder="Contoh: RPL">
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="L" <?php echo e(old('jenis_kelamin', $anggota->jenis_kelamin) == 'L' ? 'selected' : ''); ?>>Laki-laki</option>
                        <option value="P" <?php echo e(old('jenis_kelamin', $anggota->jenis_kelamin) == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('alamat', $anggota->alamat)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views/anggota/edit.blade.php ENDPATH**/ ?>