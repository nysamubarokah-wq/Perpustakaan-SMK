<?php $__env->startSection('title', 'Scan Barcode Buku'); ?>
...
(function() {
    ...
    var CEK_URL = '<?php echo e(route("admin.scanner.cek")); ?>';
    var CEK_PEMINJAMAN_URL = '<?php echo e(route("admin.scanner.cek-peminjaman")); ?>';
    var PINJAM_URL = '<?php echo e(route("admin.scanner.pinjam")); ?>';
    var KEMBALI_URL = '<?php echo e(route("admin.scanner.kembali")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\admin\scanner.blade.php ENDPATH**/ ?>