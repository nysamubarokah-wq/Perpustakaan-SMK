                        ...
                        <div class="floating-dropdown genre-dropdown-wrapper" id="genreDropdown">
                            ...
                            <div class="genre-dropdown-body">
                                <div class="genre-grid" id="genreGrid">
                                    <a href="<?php echo e(route('koleksi.terbaru', $penerbit ? ['penerbit' => $penerbit] : [])); ?>" class="genre-grid-item <?php echo e(!$genre ? 'active' : ''); ?>" data-genre="">
                                    ...
                                    <a href="<?php echo e(route('koleksi.terbaru', array_filter(['genre' => $g->id, 'penerbit' => $penerbit]))); ?>" class="genre-grid-item <?php echo e($genre == $g->id ? 'active' : ''); ?>" data-genre="<?php echo e(strtolower($g->nama)); ?>">
...
<div class="container" style="padding-top:24px">
    <div class="penerbit-scroll">
        <a href="<?php echo e(route('koleksi.terbaru', $genre ? ['genre' => $genre] : [])); ?>" class="penerbit-chip <?php echo e(!$penerbit ? 'active' : ''); ?>">Semua</a>
        <?php $__currentLoopData = $penerbitList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('koleksi.terbaru', array_filter(['penerbit' => $p->id, 'genre' => $genre]))); ?>" class="penerbit-chip <?php echo e($penerbit == $p->id ? 'active' : ''); ?>"><?php echo e($p->nama); ?></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
<?php endif; ?>
...
<div class="page-section">
    <div class="container">
        ...
        <div class="empty-state">
            ...
            <a href="<?php echo e(route('koleksi.terbaru')); ?>" class="btn btn-outline-success mt-3" style="border-radius:10px">Lihat Semua Buku Terbaru</a>
            <?php else: ?>
            <a href="<?php echo e(route('koleksi.index')); ?>" class="btn btn-outline-success mt-3" style="border-radius:10px">Lihat Semua Buku</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views/koleksi/terbaru.blade.php ENDPATH**/ ?>