...
<nav class="navbar">
    <div class="container-fluid px-4">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" style="color:#1a6e35;text-decoration:none;font-size:14px;font-weight:500">
...
(function() {
    ...
    var CEK_URL = '<?php echo e(route("barcode.cekBuku")); ?>';
    var PINJAM_URL = '<?php echo e(route("barcode.pinjam")); ?>';
    var KEMBALI_URL = '<?php echo e(route("barcode.kembali")); ?>';
    var IS_VIP = <?php echo e($isVip ? 'true' : 'false'); ?>;
    var USER_NAME = '<?php echo e(addslashes(auth()->user()->name)); ?>';
...
<?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\barcode\scanner.blade.php ENDPATH**/ ?>