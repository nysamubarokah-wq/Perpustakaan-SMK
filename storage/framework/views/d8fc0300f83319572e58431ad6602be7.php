...
(function() {
    ...
    const isVip = <?php echo e(auth()->user()->is_vip && auth()->user()->vip_expired_at && now()->lt(auth()->user()->vip_expired_at) ? 'true' : 'false'); ?>;
    ...
    function processIsbn(isbn) {
        fetch('<?php echo e(route("barcode.cekBuku")); ?>', {
            method: 'POST',
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\components\fab-scan.blade.php ENDPATH**/ ?>