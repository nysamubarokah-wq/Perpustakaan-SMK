...
<nav class="navbar">
    <a href="<?php echo e(route('koleksi.index')); ?>" class="d-flex align-items-center gap-2 text-decoration-none">
        <img src="<?php echo e(asset('images/logo.jpg')); ?>" style="width:40px;height:40px;border-radius:50%;object-fit:cover">
...
<div class="vip-container">
    ...
    <div class="vip-card" style="background:linear-gradient(135deg,#f59e0b,#fbbf24);border-radius:20px;padding:30px;text-align:center;color:white;margin-bottom:20px;box-shadow:0 5px 25px rgba(245,158,11,0.3)">
        ...
        <div class="vip-subtitle">Aktif <?php echo e($sisaHari); ?> hari lagi</div>
        <div class="vip-expired">Expired: <?php echo e(auth()->user()->vip_expired_at->format('d M Y')); ?></div>
    </div>
    <?php else: ?>
    ...
    <div class="vip-card">
        ...
        <div class="vip-price-row">
            ...
            <div style="text-align:right">
                ...
                <div class="vip-price-value" style="color:#222">🪙 <?php echo e($user->coin ?? 0); ?></div>
            </div>
        </div>
        ...
        <?php else: ?>
            <button disabled
                ...
                🪙 Koin Tidak Cukup (kurang <?php echo e(100 - ($user->coin ?? 0)); ?> koin)
            </button>
            <div class="vip-note">
...
<?php echo $__env->make('components.fab-scan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

</body>
</html><?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\vip\index.blade.php ENDPATH**/ ?>