...
<head>
    <meta charset="UTF-8">
    <title>Cetak QR - <?php echo e($buku->kode_buku); ?></title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card h2 { font-size: 14px; color: #222; margin-bottom: 3px; max-width: 260px; }
...
<body>
    <div class="card">
        <h2><?php echo e($buku->judul); ?></h2>
        <div class="kode"><?php echo e($buku->kode_buku); ?></div>
        <div class="isbn">ISBN: <?php echo e($buku->isbn ?? '-'); ?></div>
        <div class="qr-wrap"><?php echo $svg; ?></div>
    </div>
    <script>window.print();</script>
</body>
</html>
<?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\buku\qr-print.blade.php ENDPATH**/ ?>