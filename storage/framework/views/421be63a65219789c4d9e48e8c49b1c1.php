<?php $__env->startSection('header_title', 'Tambah Anggota'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Tambah Anggota','icon' => 'bi bi-person-plus','backUrl' => route('anggota.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tambah Anggota','icon' => 'bi bi-person-plus','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('anggota.index'))]); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nis')); ?>" placeholder="Nomor Induk Siswa" required>
                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_telepon')); ?>" placeholder="08xxx atau +62xxx">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('kelas')); ?>" placeholder="Contoh: X RPL 1">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('jurusan')); ?>" placeholder="Contoh: RPL">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views/anggota/create.blade.php ENDPATH**/ ?>