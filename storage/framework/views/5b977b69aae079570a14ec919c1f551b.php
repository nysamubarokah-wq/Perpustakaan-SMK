...
<body>
    <div class="no-print" style="text-align:center;margin-bottom:20px">
        ...
        <a href="<?php echo e(route('buku.index')); ?>" style="display:inline-block;margin-left:10px;padding:10px 24px;background:#f0f0f0;color:#555;border:none;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none">
            Kembali
        </a>
    </div>
    <div class="header">
        <h1>QR Code Buku</h1>
        <p>Total: <?php echo e(count($items)); ?> buku &mdash; Dicetak: <?php echo e(date('d M Y H:i')); ?></p>
    </div>
    <div class="grid">
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <h3><?php echo e($item['buku']->judul); ?></h3>
            <div class="kode"><?php echo e($item['buku']->kode_buku); ?></div>
...
<?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views/buku/qr-print-all.blade.php ENDPATH**/ ?>