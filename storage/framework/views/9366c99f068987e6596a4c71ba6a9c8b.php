...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Edit Anggota','icon' => 'bi bi-person-gear','backUrl' => route('anggota.index', $backParams)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Anggota','icon' => 'bi bi-person-gear','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('anggota.index', $backParams))]); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nis', $anggota->nis)); ?>" placeholder="Nomor Induk Siswa">
                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
