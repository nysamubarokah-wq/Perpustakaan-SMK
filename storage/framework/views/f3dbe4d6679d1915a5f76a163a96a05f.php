...
(function() {
    ...
    var CEK_URL = '<?php echo e(route("admin.scanner.cek")); ?>'.replace(/^https?:\/\/[^/]+/, '');
    ...
    function tampilkanHasil() {
        ...
        if (p) {
            ...
            aksiHtml = '<div style="border-top:1px solid #eee;padding-top:16px;margin-top:16px">'
                ...
                + '</div>'
                + '<form method="POST" action="<?php echo e(route("admin.scanner.kembali")); ?>">'
                + '<?php echo csrf_field(); ?>'
            ...
            aksiHtml = '<div style="border-top:1px solid #eee;padding-top:16px;margin-top:16px">'
                ...
                + '<form method="POST" action="<?php echo e(route("admin.scanner.pinjam")); ?>" onsubmit="return validateAnggota()">'
                + '<?php echo csrf_field(); ?>'
                + '<input type="hidden" name="buku_id" value="' + b.id + '">'
