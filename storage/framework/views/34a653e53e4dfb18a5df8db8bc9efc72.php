...
<?php $__env->startSection('header_title', 'Tambah Background'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-page-header','data' => ['title' => 'Tambah Background','icon' => 'bi bi-plus-circle','backUrl' => route('background.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tambah Background','icon' => 'bi bi-plus-circle','backUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('background.index'))]); ?>
...
<div class="card-admin">
    <div class="card-admin-body">
        <form action="<?php echo e(route('background.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('harga')); ?>">
...
unset($__errorArgs, $__bag); ?>" onchange="toggleTipe()">
                        <option value="color" <?php echo e(old('type') == 'color' ? 'selected' : ''); ?>>Warna</option>
                        <option value="image" <?php echo e(old('type') == 'image' ? 'selected' : ''); ?>>Foto</option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PerpustakaanDigital\resources\views\background\create.blade.php ENDPATH**/ ?>